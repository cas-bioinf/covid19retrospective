...
```{r markeroverlaps, fig.cap = "Density plots of worst marker values per patient, stratified by worst condition experienced by the patient.", fig.height=6}
frac <- 0.2
data$marker_data %>% filter(marker %in% c("lymphocyte_count", "d_dimer", "CRP", "IL_6")) %>%
