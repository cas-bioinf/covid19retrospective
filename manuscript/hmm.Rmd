...
serie_data <- wide %>%
  ...
  #mutate(best_supportive_care = as.integer(best_supportive_care))   
...
trt_group_m1_initial_states <- serie_data %>% filter(.time == 1) %>% arrange(.serie) %>% pull(.observed)
...
trt_group_m1 <- brmshmmdata(trt_group_m1_formula, serie_data, 
                  trt_group_m1_rate_data, simple_hidden_state_data, simple_initial_states, prior = trt_group_m1_prior,
                  observed_state_data = base_observed_state_data)

trt_group_m1_fit <- brmhmm(trt_group_m1, cache_file = paste0(cache_dir,"/trt_group_m1.rds"), control = default_control, init = 0.1)
...
```{r trt_group_m2}
trt_group_m2_formula <- update.formula(trt_group_m1_formula,  ~ . +  (age_norm + sex || rate_group))
trt_group_m2 <- brmshmmdata(trt_group_m2_formula, serie_data, 
                  trt_group_m1_rate_data, trt_group_m1_hidden_state_data, trt_group_m1_initial_states, prior = trt_group_m1_prior,
                  observed_state_data = trt_group_m1_observed_state_data)

trt_group_m2_fit <- brmhmm(trt_group_m2, cache_file = paste0(cache_dir,"/trt_group_m2.rds"), init = 0.1)
...
trt_group_m3_fit <- brmhmm(trt_group_m3, cache_file = paste0(cache_dir,"/trt_group_m3.rds"), init = 0.1)
...
```{r trt_group_m4}
trt_group_m4_formula <-  update.formula(trt_group_m3_formula ~ . + (comorbidities_sum || rate_group)) trt_group_m4 <- brmshmmdata(trt_group_m4_formula, serie_data, 
                  trt_group_m1_rate_data, trt_group_m1_hidden_state_data, trt_group_m1_initial_states, prior = trt_group_m1_prior,
                  observed_state_data = trt_group_m1_observed_state_data)

trt_group_m4_fit <- brmhmm(trt_group_m4, cache_file = paste0(cache_dir,"/trt_group_m4.rds"), init = 0.1)
...
trt_rate_m1_rate_data <- trt_group_m1_rate_data

trt_rate_m1_initial_states <- trt_group_m1_initial_states
...
```{r trt_rate_m2}
trt_rate_m2_formula <- update.formula(trt_rate_m1_formula,  ~ . +  (age_norm + sex || .rate_id))
...
trt_rate_m2_fit <- brmhmm(trt_rate_m2, cache_file = paste0(cache_dir,"/trt_rate_m2.rds"), init = 0.1)
...
trt_rate_m3_fit <- brmhmm(trt_rate_m3, cache_file = paste0(cache_dir,"/trt_rate_m3.rds"), init = 0.1)
...
trt_rate_m4_fit <- brmhmm(trt_rate_m4, cache_file = paste0(cache_dir,"/trt_rate_m4.rds"), init = 0.1)
...
d_dimer_m1 <- brmshmmdata(d_dimer_m1_formula, d_dimer_serie_data, 
                  trt_group_m1_rate_data, trt_group_m1_hidden_state_data, d_dimer_initial_states, prior = trt_group_m1_prior,
                  observed_state_data = trt_group_m1_observed_state_data)

d_dimer_m1_fit <- brmhmm(trt_m6, cache_file = paste0(cache_dir,"/d_dimer_m1.rds"), init = 0.1)
...
```{r}
d_dimer_m2_formula <-  update.formula(d_dimer_m1_formula, ~ . + (age_norm + sex + comorbidities_sum || rate_group))
...
d_dimer_m2_fit <- brmhmm(trt_m6, cache_file = paste0(cache_dir,"/d_dimer_m2.rds"), init = 0.1)
...
IL_6_m1 <- brmshmmdata(IL_6_initial_states, IL_6_serie_data, 
                  trt_group_m1_rate_data, trt_group_m1_hidden_state_data, IL_6_initial_states, prior = trt_group_m1_prior,
                  observed_state_data = trt_group_m1_observed_state_data)

IL_6_m1_fit <- brmhmm(IL_6_m1, cache_file = paste0(cache_dir,"/IL_6_m1.rds"), init = 0.1)
...
```{r}
IL_6_m2_formula <-  update.formula(IL_6_m1_formula, ~ . + (age_norm + sex + comorbidities_sum || rate_group))

IL_6_m2 <- brmshmmdata(IL_6_initial_states, IL_6_serie_data, 
                  trt_group_m1_rate_data, trt_group_m1_hidden_state_data, IL_6_initial_states, prior = trt_group_m1_prior,
                  observed_state_data = trt_group_m1_observed_state_data)

IL_6_m2_fit <- brmhmm(IL_6_m2, cache_file = paste0(cache_dir,"/IL_6_m2.rds"), init = 0.1)
