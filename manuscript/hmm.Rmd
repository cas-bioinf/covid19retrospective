...
hcq_m1_initial_states <- serie_data %>% filter(.time == 1) %>% arrange(.serie) %>% pull(.observed)
...
hcq_m1 <- brmshmmdata(hcq_m1_formula, serie_data, 
...
# 
# 
# hcq_m1_counterfactual_took_hcq <- hcq_m1
# hcq_m1_counterfactual_took_hcq$serie_data = counterfactual_took_hcq
# 
# hcq_m1_counterfactual_took_hcq_epred_rect <- posterior_epred_rect(hcq_m1_fit, newdata = hcq_m1_counterfactual_took_hcq)
# 
# hcq_m1_counterfactual_no_hcq <- hcq_m1
# hcq_m1_counterfactual_no_hcq$serie_data = counterfactual_no_hcq
# 
# hcq_m1_counterfactual_no_hcq_epred_rect <- posterior_epred_rect(hcq_m1_fit, newdata = hcq_m1_counterfactual_no_hcq)


```

```{r}
draws <- tidybayes::tidy_draws(hcq_m1_fit$brmsfit)
hmm_hypothesis_res_list[["hcq_m1_death"]] <- 
...
hmm_hypothesis_res_list[["hcq_m1_discharged"]] <- 
  bayesian_hypothesis_res_from_draws(
...
hcq_m2 <- brmshmmdata(hcq_m2_formula, serie_data, 
                  hcq_m1_rate_data, hcq_m1_hidden_state_data, hcq_m1_initial_states, prior = hcq_m1_prior,
                  observed_state_data = hcq_m1_observed_state_data)
...
```{r}
draws <- tidybayes::tidy_draws(hcq_m2_fit$brmsfit)
hmm_hypothesis_res_list[["hcq_m2_death"]] <- 
  bayesian_hypothesis_res_from_draws(
    draws = draws$b_took_hcqTRUE,
    model = "HMM",
    estimand = "log(HR)",
...
hmm_hypothesis_res_list[["hcq_m2_discharged"]] <- 
  bayesian_hypothesis_res_from_draws(
    draws = draws$b_took_hcqTRUE + draws$`b_rate_groupimprove_one:took_hcqTRUE`,
    model = "HMM",
    estimand = "log(HR)",
...
hcq_m3 <- brmshmmdata(hcq_m3_formula, serie_data, 
                  hcq_m1_rate_data, hcq_m1_hidden_state_data, hcq_m1_initial_states, prior = hcq_m1_prior,
                  observed_state_data = hcq_m1_observed_state_data)
...
```{r}
draws <- tidybayes::tidy_draws(hcq_m3_fit$brmsfit)
hmm_hypothesis_res_list[["hcq_m3_death"]] <- 
  bayesian_hypothesis_res_from_draws(
    draws = draws$b_took_hcqTRUE,
    model = "HMM",
    estimand = "log(HR)",
...
hmm_hypothesis_res_list[["hcq_m3_discharged"]] <- 
  bayesian_hypothesis_res_from_draws(
    draws = draws$b_took_hcqTRUE + draws$`b_rate_groupimprove_one:took_hcqTRUE`,
    model = "HMM",
    estimand = "log(HR)",
...
hcq_m4 <- brmshmmdata(hcq_m4_formula, serie_data, 
                  hcq_m1_rate_data, hcq_m1_hidden_state_data, hcq_m1_initial_states, prior = hcq_m1_prior,
                  observed_state_data = hcq_m1_observed_state_data)
...
```{r}
draws <- tidybayes::tidy_draws(hcq_m4_fit$brmsfit)
hmm_hypothesis_res_list[["hcq_m4_death"]] <- 
  bayesian_hypothesis_res_from_draws(
    draws = draws$b_took_hcqTRUE,
    model = "HMM",
    estimand = "log(HR)",
...
hmm_hypothesis_res_list[["hcq_m4_discharged"]] <- 
  bayesian_hypothesis_res_from_draws(
    draws = draws$b_took_hcqTRUE + draws$`b_rate_groupimprove_one:took_hcqTRUE`,
    model = "HMM",
    estimand = "log(HR)",
...
hmm_hypothesis_res_list[["hcq_m4_death_az"]] <- 
  bayesian_hypothesis_res_from_draws(
...
hmm_hypothesis_res_list[["hcq_m4_discharged_az"]] <- 
  bayesian_hypothesis_res_from_draws(
...
hcq_m5 <- brmshmmdata(hcq_m5_formula, serie_data, 
                  hcq_m1_rate_data, hcq_m1_hidden_state_data, hcq_m1_initial_states, prior = hcq_m1_prior,
                  observed_state_data = hcq_m1_observed_state_data)
...
```{r}
draws <- tidybayes::tidy_draws(hcq_m5_fit$brmsfit)
hmm_hypothesis_res_list[["hcq_m5_death"]] <- 
  bayesian_hypothesis_res_from_draws(
    draws = draws$b_took_hcqTRUE,
    model = "HMM",
    estimand = "log(HR)",
...
hmm_hypothesis_res_list[["hcq_m5_discharged"]] <- 
  bayesian_hypothesis_res_from_draws(
    draws = draws$b_took_hcqTRUE + draws$`b_rate_groupimprove_one:took_hcqTRUE`,
    model = "HMM",
    estimand = "log(HR)",
...
hcq_m6_initial_states <- hcq_m6_serie_data %>% filter(.time == 1) %>% arrange(.serie) %>% pull(.observed)
...
hcq_m6 <- brmshmmdata(hcq_m6_formula, hcq_m6_serie_data, 
...
```{r}
draws <- tidybayes::tidy_draws(hcq_m6_fit$brmsfit)
hmm_hypothesis_res_list[["hcq_m6_d_dimer_death"]] <- 
  bayesian_hypothesis_res_from_draws(
...
hcq_m7_initial_states <- hcq_m7_serie_data %>% filter(.time == 1) %>% arrange(.serie) %>% pull(.observed)
...
hcq_m7 <- brmshmmdata(hcq_m7_formula, hcq_m7_serie_data, 
...
```{r}
draws <- tidybayes::tidy_draws(hcq_m7_fit$brmsfit)
hmm_hypothesis_res_list[["hcq_m7_IL_6_death"]] <- 
  bayesian_hypothesis_res_from_draws(
