...
compute_counterfactual_mortality_log_OR <- function(hmm_fit, numerator_serie_data, denominator_serie_data, day = 28) {
  ...
  numerator_data <- hmm_fit$data
  numerator_data$serie_data = numerator_serie_data
  
  numerator_state_probs <- posterior_epred_rect(hmm_fit, newdata = numerator_data, method = posterior_epred_state_prob)
  
  denominator_data <- hmm_fit$data
  denominator_data$serie_data = denominator_serie_data
  
  denominator_state_probs <- posterior_epred_rect(hmm_fit, newdata = denominator_data, method = posterior_epred_state_prob)  
  
  mortality_state <- which(hmm_fit$data$hidden_state_data$id == "Death")
  samples_probs_numerator <- 
    rowMeans(numerator_state_probs[mortality_state, day + 1, ,])
  samples_probs_denominator <- 
    rowMeans(denominator_state_probs[mortality_state, day + 1, ,])
...
```{r}
hmm_hypothesis_res_list[["trt_group_m1"]] <- evaluate_all_treatment_hypotheses(trt_group_m1_fit, model_subgroup = "simple_group", adjusted ="all treatments, supportive", model_check = "Suspicious")
```
...
```{r}
hhmm_hypothesis_res_list[["trt_group_m2"]] <- evaluate_all_treatment_hypotheses(trt_group_m2_fit, model_subgroup = "simple_group", adjusted ="all treatments, supportive, age, sex", model_check = "Suspicious")
```
...
```{r}
hhmm_hypothesis_res_list[["trt_group_m3"]] <-  evaluate_all_treatment_hypotheses(trt_group_m3_fit, model_subgroup = "simple_group", adjusted ="all treatments, supportive, age, sex, hospital", model_check = "OK")
```
...
```{r}
hhmm_hypothesis_res_list[["trt_group_m4"]] <-  evaluate_all_treatment_hypotheses(trt_group_m4_fit, model_subgroup = "simple_group", adjusted ="all treatments, supportive, age, sex, hospital, comorbidities", model_check = "OK")
```
...
```{r}
hhmm_hypothesis_res_list[["trt_rate_m1"]] <-  evaluate_all_treatment_hypotheses(trt_rate_m1_fit, model_subgroup = "simple_rate", adjusted ="all treatments, supportive", model_check = "Suspicious")
```
...
```{r}
hhmm_hypothesis_res_list[["trt_rate_m2"]] <-  evaluate_all_treatment_hypotheses(trt_rate_m2_fit, model_subgroup = "simple_rate", adjusted ="all treatments, supportive, age, sex", model_check = "Suspicious")
```
...
```{r}
hhmm_hypothesis_res_list[["trt_rate_m3"]] <-  evaluate_all_treatment_hypotheses(trt_rate_m3_fit, model_subgroup = "simple_rate", adjusted ="all treatments, supportive, age, sex, hospital", model_check = "OK")
```
...
```{r}
hhmm_hypothesis_res_list[["trt_rate_m4"]] <- evaluate_all_treatment_hypotheses(trt_rate_m4_fit, model_subgroup = "simple_rate", adjusted ="all treatments, supportive, age, sex, hospital, comorbidities", model_check = "OK")
```
...
hhmm_hypothesis_res_list[["d_dimer_m1_death"]] <-
  bayesian_hypothesis_res_from_draws(
...
hhmm_hypothesis_res_list[["trt_m7_IL_6_death"]] <-
  bayesian_hypothesis_res_from_draws(
...
```{r}
hhmm_hypothesis_res_list[["c_trt_rate_m1"]] <- evaluate_all_treatment_hypotheses(c_trt_m1_fit, model_subgroup = "complex_group", adjusted ="all treatments, supportive", model_check = "Suspicious")
```
...
```{r}
hhmm_hypothesis_res_list[["c_trt_rate_m2"]] <- evaluate_all_treatment_hypotheses(c_trt_m2_fit, model_subgroup = "complex_group", adjusted ="all treatments, supportive, age, sex", model_check = "Suspicious")
...
```{r}
hhmm_hypothesis_res_list[["c_trt_rate_m3"]] <- evaluate_all_treatment_hypotheses(c_trt_m3_fit, model_subgroup = "complex_group", adjusted ="all treatments, supportive, age, sex, hospital", model_check = "Suspicious")
...
```{r}
hhmm_hypothesis_res_list[["c_trt_rate_m4"]] <- evaluate_all_treatment_hypotheses(c_trt_m4_fit, model_subgroup = "complex_group", adjusted ="all treatments, supportive, age, sex, hospital, comorbidities", model_check = "Suspicious")
...
```{r}
hmm_hypothesis_res_all <- do.call(rbind, hhmm_hypothesis_res_list)
