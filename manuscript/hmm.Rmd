...
```{r setup_hmm, echo=FALSE, message=FALSE, warning = FALSE, results = "hide",cache=FALSE}
...
res_fpv <- tibble::tribble(
  ...
  "Death",  death_res$point_estimate, NA, death_res$ci_low, death_res$ci_high,
