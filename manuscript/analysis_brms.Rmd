...
pp_check(fit_survival_base, "error_binned")
loo(fit_survival_base)
...
pp_check(fit_survival_base_7, "error_binned")
loo(fit_survival_base_7)
...
pp_check(fit_survival_base_28, "error_binned")
loo(fit_survival_base_28)
...
```
There were some very influential observations.
...
pp_check(fit_discharged_base, "error_binned")
loo(fit_discharged_base)
...
pp_check(fit_discharged_base_7, "error_binned")
loo(fit_discharged_base_7)
...
pp_check(fit_outcome_base_7)
loo(fit_outcome_base_7)
...
pp_check(fit_outcome_base_7_fw)
loo(fit_outcome_base_7_fw)
...
loo(fit_outcome_base_28_fw)
# ce <- conditional_effects(fit_outcome_base_28_fw)
# plot(ce, ask = FALSE)
```
