...
hypothesis_res_list[["competing_hcq_az_survival_base"]] <- rbind(
...
hypothesis_res_list[["competing_hcq_az_survival_time"]] <- rbind(
  bayesian_hypothesis_res_from_draws(
    draws = draws$b_ever_hcqTRUE,
    model = "brms_cox",
    estimand = "log(HR)",
...
hypothesis_res_list[["competing_hcq_az_discharged_base"]] <- rbind(
  bayesian_hypothesis_res_from_draws(
    draws = draws$b_ever_hcqTRUE,
    model = "brms_binary",
...
hypothesis_res_list[["competing_hcq_az_discharged_time"]] <- rbind(
  bayesian_hypothesis_res_from_draws(
    draws = draws$b_ever_hcqTRUE,
    model = "brms_cox",
    estimand = "log(HR)",
