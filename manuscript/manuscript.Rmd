---
title: "Detailed disease progression of 97 patients hospitalized with Covid-19 in the Czech Republic: An exploratory analysis" 
output: 
...
We searched the living systematic review of Covid-19 prognostic models [@http://zotero.org/users/5567156/items/TS57HJ3T] for models that could be applied to our dataset (i.e. where we have gathered all the input features). This resulted in five usable models: [@http://zotero.org/users/5567156/items/EN4GICJ6; @http://zotero.org/users/5567156/items/INZVABQI; @http://zotero.org/users/5567156/items/3A2RN4ZS; @http://zotero.org/users/5567156/items/4DDUVEKS; @http://zotero.org/users/5567156/items/X4GWJIP5].
...
```{r progression, fig.cap="Disease progression for all patients included in the study as determined by breathing support required. AA = Ambient air, Oxygen = Nasal oxygen, NIPPV = Non-invasive positive-pressure ventilation, ECMO = Extra-corporeal membrane oxygenation."}
my_paste <- function(x) {
