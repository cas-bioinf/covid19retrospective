...
hypothesis_res_list[["competing_hcq_az_fpv"]] <-
  ...
  frequentist_hypothesis_res_from_coxph(hypotheses$favipiravir_reduces_death, fit_competing_hcq_az_fpv,
                                        coefficient_name = "took_favipiravirTRUE", transition = "1:3", adjusted = "age, sex, hcq, az"),
  frequentist_hypothesis_res_from_coxph(hypotheses$favipiravir_increases_discharged, fit_competing_hcq_az_fpv,
                                        coefficient_name = "took_favipiravirTRUE", transition = "1:2", adjusted = "age, sex, hcq, az")
  )
hypothesis_res_list[["competing_hcq_az_fpv"]]
```
