...
shi_et_al_auc <- list(
  ...
  my_auc(not_ventilated_admission ~ shi, shi_et_al_data, subgroup = " (at admission)"),
  my_auc(not_oxygen_admission ~ shi, shi_et_al_data, subgroup = " (at admission)")
)
...
shi_et_al_auc_reported_admission <- my_auc(severe_admission ~ shi, shie_et_al_auc_data_admission, subgroup = " (at admission)")
...
shi_et_al_auc_reported_all <- my_auc(severe_hospitalized ~ shi, shie_et_al_auc_data_all)
 
compare_auc_to_orig(list(shi_et_al_auc_reported_admission, shi_et_al_auc_reported_all), list(shi_et_al_auc), ncol = 1)
```
