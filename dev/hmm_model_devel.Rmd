...
single_code <- make_stancode_hmm(data$observed_structured$formula, 
                                 serie_data = data$observed_structured$serie_data, 
                                 rate_data = data$observed_structured$rate_data, 
                                 hidden_state_data = data$observed_structured$hidden_state_data, 
                                 observed_state_data = data$observed_structured$observed_state_data,
                                 prior= data$observed_structured$prior)

model_single <- stan_model(model_code = single_code)


standata <- make_standata_hmm(data$observed_structured$formula, 
                              serie_data = data$observed_structured$serie_data, 
                              rate_data = data$observed_structured$rate_data, 
                              hidden_state_data = data$observed_structured$hidden_state_data, 
                              observed_state_data = data$observed_structured$observed_state_data,
