...
complete_data_merged <- merge_patients(complete_data, patients_to_merge)


complete_data$patient_data %>% filter(hospital_id == "Oriik", patient_id == 3)
complete_data_merged$breathing_data %>% filter(hospital_id == "cTdij")
complete_data_merged$patient_data %>% filter(hospital_id == "cTdij")
complete_data$patient_data %>% filter(hospital_id == "cTdij")
